...
export function ThemeProvider({ children }: ThemeProviderProps) {
  const [currentThemeName, setCurrentThemeName] = useState(
    localStorage.getItem('theme') || ThemeNames.lend
  );
  ...
  const arrayOfThemes = [ThemeNames.default, ThemeNames.dark, ThemeNames.lend];

  const currentTheme: Themes[ThemeNames] =
    themes[arrayOfThemes.find((theme) => theme === currentThemeName) || ThemeNames.lend];
