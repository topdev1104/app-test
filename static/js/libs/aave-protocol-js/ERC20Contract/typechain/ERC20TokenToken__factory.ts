...
export class ERC20TokenToken__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(_maxTotalSupply, overrides || {}) as Promise<ERC20Token>;
  }
  ...
  override connect(signer: Signer): ERC20TokenToken__factory {
    return super.connect(signer) as ERC20TokenToken__factory;
  }
