...
export class PeripheryImmutableStateTest__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(_factory, _WETH9, overrides || {}) as Promise<PeripheryImmutableStateTest>;
  }
  ...
  static connect(
    ...
    return new Contract(address, _abi, signerOrProvider) as PeripheryImmutableStateTest;
  }
}
