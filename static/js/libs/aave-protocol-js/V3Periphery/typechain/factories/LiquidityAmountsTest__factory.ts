...
export class LiquidityAmountsTest__factory extends ContractFactory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): LiquidityAmountsTest {
    return new Contract(address, _abi, signerOrProvider) as LiquidityAmountsTest;
  }
}
