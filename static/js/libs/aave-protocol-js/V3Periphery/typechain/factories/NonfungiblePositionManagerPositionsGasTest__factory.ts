...
export class NonfungiblePositionManagerPositionsGasTest__factory extends ContractFactory {
  ...
  getDeployTransaction(
    ...
    return super.getDeployTransaction(_nonfungiblePositionManager, overrides || {});
  }
  ...
  connect(signer: Signer): NonfungiblePositionManagerPositionsGasTest__factory {
    return super.connect(signer) as NonfungiblePositionManagerPositionsGasTest__factory;
  }
  static connect(
    address: string,
