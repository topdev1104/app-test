    ...
    return {
        ...
        publicClient: ({
            ...
            const publicClient = createPublicClient({
                ...
                chain: activeChain,
                transport: fallback(
                    chainHttpUrls.map((url) => http(url, {
        ...
        webSocketPublicClient: ({
            ...
            const publicClient = createPublicClient({
                ...
                chain: activeChain,
                transport: fallback(
                    chainWsUrls.map((url) => webSocket(url, {
                        timeout: stallTimeout
                    })), {
                        rank,
                        retryCount,
...
function getPublicClient({
    ...
    const config2 = getConfig();
    if (chainId)
        return config2.getPublicClient({
            chainId
...
function getWebSocketPublicClient({
    ...
    const config2 = getConfig();
    if (chainId)
        return config2.getWebSocketPublicClient({
            chainId
...
async function fetchFeeData({
    ...
    if (block ? .baseFeePerGas) {
        ...
        maxFeePerGas = block.baseFeePerGas * 2 n + maxPriorityFeePerGas;
    }
