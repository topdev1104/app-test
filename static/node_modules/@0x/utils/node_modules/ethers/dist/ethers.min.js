    ...
    return function n(i, o, s) {
        ...
        4: [function(e, t, r) {
            ...
            var s, u = e("./constants"),
                ...
                m = e("./abstract-signer"),
                g = (s = m.Signer, i(v, s), v.prototype.getAddress = function() {
                    ...
                    return ["data", "to"].forEach(function(e) {
                        ...
                        function n(i, o, e) {
                            ...
                            if (i.data = a.encode(n), "call" === a.type) return s ? Promise.resolve(u.Zero) : (o.provider || l.throwError("call (constant functions) require a provider or a signer with a provider", l.UNSUPPORTED_OPERATION, {
                                ...
                                var e;
                                c.hexDataLength(t) % 32 == 4 && "0x08c379a0" === c.hexDataSlice(t, 0, 4) && (e = h.defaultAbiCoder.decode(["string"], c.hexDataSlice(t, 4)), l.throwError("call revert exception", l.CALL_EXCEPTION, {
                                    address: o.address,
                                    args: n,
                                    method: a.signature,
                                ...
                                try {
                                    var r = a.decode(t);
                                    return r = 1 === a.outputs.length ? r[0] : r
                                } catch (e) {
            ...
            var M = (A.prototype.deployed = function() {
                ...
                if (e.topics && e.topics[0])
                    for (var o in t.topics = e.topics, this.interface.events)
                        if (-1 !== o.indexOf("(")) {
                            o = this.interface.events[o];
                            if (o.topic === e.topics[0].toLowerCase()) {
                                i = o;
                                break
                            }
                        }
        ...
        6: [function(e, t, r) {
            ...
            e = e("./_version");
            r.version = e.version, r.getDefaultProvider = function(e) {
        ...
        8: [function(e, O, C) {
            ...
            ! function(e) {
                ...
                k.prototype._prepare = function() {
                    ...
                    for (var o = 1; o < t; o++) {
                        for (i = 0; i < 4; i++) r[i] = h[n[i] >> 24 & 255] ^ p[n[(i + 1) % 4] >> 16 & 255] ^ y[n[(i + 2) % 4] >> 8 & 255] ^ m[255 & n[(i + 3) % 4]] ^ this._Ke[o][i];
                        n = r.slice()
                    }
                    for (var s, a = u(16), i = 0; i < 4; i++) s = this._Ke[t][i], a[4 * i] = 255 & (d[n[i] >> 24 & 255] ^ s >> 24), a[4 * i + 1] = 255 & (d[n[(i + 1) % 4] >> 16 & 255] ^ s >> 16), a[4 * i + 2] = 255 & (d[n[(i + 2) % 4] >> 8 & 255] ^ s >> 8), a[4 * i + 3] = 255 & (d[255 & n[(i + 3) % 4]] ^ s);
                    return a
                    ...
                    for (var s, a = u(16), i = 0; i < 4; i++) s = this._Kd[t][i], a[4 * i] = 255 & (l[n[i] >> 24 & 255] ^ s >> 24), a[4 * i + 1] = 255 & (l[n[(i + 3) % 4] >> 16 & 255] ^ s >> 16), a[4 * i + 2] = 255 & (l[n[(i + 2) % 4] >> 8 & 255] ^ s >> 8), a[4 * i + 3] = 255 & (l[255 & n[(i + 1) % 4]] ^ s);
                    return a
                };
                var N = function(e) {
                ...
                var P = function(e, t, r) {
                    ...
                    this.segmentSize = r = r || 1, this._shiftRegister = o(t, !0), this._aes = new k(e)
                };
                P.prototype.encrypt = function(e) {
                    ...
                    for (var t = o(e, !0), r = 0; r < t.length; r += this.segmentSize) {
                        ...
                        s(this._shiftRegister, this._shiftRegister, 0, this.segmentSize), s(t, this._shiftRegister, 16 - this.segmentSize, r, r + this.segmentSize)
                    }
                    return t
                ...
                var T = function(e) {
                    ...
                    "number" == typeof(e = 0 !== e && !e ? 1 : e) ? (this._counter = u(16), this.setValue(e)) : this.setBytes(e)
                };
                ...
                void 0 !== C ? O.exports = t : (e.aesjs && (t._aesjs = e.aesjs), e.aesjs = t)
            }(this)
        }, {}],
        9: [function(E, e, t) {
            ! function(e, t) {
                ...
                m.isBN = function(e) {
                    ...
                    var s = 0;
                    if ("be" === r)
                        for (o = e.length - 1, n = 0; 0 <= o; o -= 3) i = e[o] | e[o - 1] << 8 | e[o - 2] << 16, this.words[n] |= i << s & 67108863, this.words[n + 1] = i >>> 26 - s & 67108863, 26 <= (s += 24) && (s -= 26, n++);
                    else if ("le" === r)
                        for (n = o = 0; o < e.length; o += 3) i = e[o] | e[o + 1] << 8 | e[o + 2] << 16, this.words[n] |= i << s & 67108863, this.words[n + 1] = i >>> 26 - s & 67108863, 26 <= (s += 24) && (s -= 26, n++);
                    return this.strip()
                    ...
                    var i, o = 0,
                        s = 0;
                    if ("be" === r)
                        for (n = e.length - 1; t <= n; n -= 2) i = a(e, t, n) << o, this.words[s] |= 67108863 & i, 18 <= o ? (o -= 18, this.words[s += 1] |= i >>> 26) : o += 8;
                    else
                        for (n = (e.length - t) % 2 == 0 ? t + 1 : t; n < e.length; n += 2) i = a(e, t, n) << o, this.words[s] |= 67108863 & i, 18 <= o ? (o -= 18, this.words[s += 1] |= i >>> 26) : o += 8;
                    this.strip()
                }, m.prototype._parseBase = function(e, t, r) {
                    this.words = [0];
                    for (var n = 0, i = this.length = 1; i <= 67108863; i *= t) n++;
                    for (var i = i / t | 0, o = e.length - r, s = o % --n, a = Math.min(o, o - s) + r, u = 0, l = r; l < a; l += n) u = f(e, l, l + n, t), this.imuln(i), this.words[0] + u < 67108864 ? this.words[0] += u : this._iaddn(u);
                    if (0 != s) {
                        for (var h = 1, u = f(e, l, e.length, t), l = 0; l < s; l++) h *= t;
                ...
                m.prototype.toString = function(e, t) {
                    if (t = 0 | t || 1, 16 === (e = e || 10) || "hex" === e) {
                        ...
                        for (var r = 0, n = 0, i = 0; i < this.length; i++) {
                            var o = this.words[i],
                                s = (16777215 & (o << r | n)).toString(16),
                                a = 0 !== (n = o >>> 24 - r & 16777215) || i !== this.length - 1 ? c[6 - s.length] + s + a : s + a;
                            26 <= (r += 2) && (r -= 26, i--)
                        }
                    ...
                    if (e === (0 | e) && 2 <= e && e <= 36) {
                        ...
                        for (a = "", (h = this.clone()).negative = 0; !h.isZero();) {
                            ...
                            a = (h = h.idivn(l)).isZero() ? f + a : c[u - f.length] + f + a
                        }
                ...
                var s = function(e, t, r) {
                    ...
                    var K = (0 + Math.imul(a, D) | 0) + ((8191 & (H = (H = Math.imul(a, U)) + Math.imul(u, D) | 0)) << 13) | 0,
                        ee = ((Z = Math.imul(u, U)) + (H >>> 13) | 0) + (K >>> 26) | 0;
                ...
                Math.imul || (s = o), m.prototype.mulTo = function(e, t) {
                    var r = this.length + e.length,
                        t = (10 === this.length && 10 === e.length ? s : r < 63 ? o : r < 1024 ? function(e, t, r) {
                    ...
                    return n
                }, l.prototype.permute = function(e, t, r, n, i, o) {
                    for (var s = 0; s < o; s++) n[s] = t[e[s]], i[s] = r[e[s]]
                }, l.prototype.transform = function(e, t, r, n, i, o) {
                    ...
                    return e
                }, l.prototype.convert13b = function(e, t, r, n) {
                    ...
                    if (0 != t) {
                        for (var i = 0, o = 0; o < this.length; o++) {
                            var s = this.words[o] & n,
                                a = (0 | this.words[o]) - s << t;
                    ...
                    for (var i = 0, o = 0; o < e.length; o++) {
                        var s = (0 | this.words[o + r]) + i,
                            a = (0 | e.words[o]) * t,
                            i = ((s -= 67108863 & a) >> 26) - (a / 67108864 | 0);
                    ...
                    for (y(-1 === i), o = i = 0; o < this.length; o++) i = (s = -(0 | this.words[o]) + i) >> 26, this.words[o] = 67108863 & s;
                    ...
                    for (var t = this, r = e.clone(), t = 0 !== t.negative ? t.umod(e) : t.clone(), n = new m(1), i = new m(0), o = new m(0), s = new m(1), a = 0; t.isEven() && r.isEven();) t.iushrn(1), r.iushrn(1), ++a;
                    ...
                    y(0 === e.negative), y(!e.isZero());
                    for (var t, r = this, n = e.clone(), r = 0 !== r.negative ? r.umod(e) : r.clone(), i = new m(1), o = new m(0), s = n.clone(); 0 < r.cmpn(1) && 0 < n.cmpn(1);) {
                        for (var a = 0, u = 1; 0 == (r.words[0] & u) && a < 26; ++a, u <<= 1);
                        if (0 < a)
                            for (r.iushrn(a); 0 < a--;) i.isOdd() && i.iadd(s), i.iushrn(1);
                        for (var l = 0, h = 1; 0 == (n.words[0] & h) && l < 26; ++l, h <<= 1);
                        if (0 < l)
                            for (n.iushrn(l); 0 < l--;) o.isOdd() && o.iadd(s), o.iushrn(1);
                ...
                function M(e) {
                    var t;
                    "string" == typeof e ? (t = m._prime(e), this.m = t.p, this.prime = t) : (y(e.gtn(1), "modulus must be greater than 1"), this.m = e, this.prime = null)
                }

                function A(e) {
                    M.call(this, e), this.shift = this.m.bitLength(), this.shift % 26 != 0 && (this.shift += 26 - this.shift % 26), this.r = new m(1).iushln(this.shift), this.r2 = this.imod(this.r.sqr()), this.rinv = this.r._invmp(this.m), this.minv = this.rinv.mul(this.r).isubn(1).div(this.m), this.minv = this.minv.umod(this.r), this.minv = this.r.sub(this.minv)
                }
                g.prototype._tmp = function() {
                ...
                }, r(v, g), v.prototype.split = function(e, t) {
                ...
                }, r(b, g), r(w, g), r(_, g), _.prototype.imulK = function(e) {
                    for (var t = 0, r = 0; r < e.length; r++) {
                    ...
                    y(!r.isZero());
                    for (var i = new m(1).toRed(this), o = i.redNeg(), s = this.m.subn(1).iushrn(1), a = new m(2 * (a = this.m.bitLength()) * a).toRed(this); 0 !== this.pow(a, s).cmp(o);) a.redIAdd(o);
                    for (var u = this.pow(a, r), l = this.pow(e, r.addn(1).iushrn(1)), h = this.pow(e, r), f = n; 0 !== h.cmp(i);) {
                        for (var c = h, d = 0; 0 !== c.cmp(i); d++) c = c.redSqr();
                        y(d < f);
                        var p = this.pow(u, new m(1).iushln(f - d - 1)),
                            l = l.redMul(p),
                            u = p.redSqr(),
                            h = h.redMul(u),
                            f = d
                    ...
                    return new A(e)
                }, r(A, M), A.prototype.convertTo = function(e) {
        ...
        13: [function(e, t, r) {
            ...
            function s(e, t) {
                ...
                for (var r = e._getNAFPoints(4), n = r.wnd, i = r.points, o = S(t, n, this._bitLength), s = this.jpoint(null, null, null), a = o.length - 1; 0 <= a; a--) {
                    ...
                    var l = o[a];
                    f(0 !== l), s = "affine" === e.type ? 0 < l ? s.mixedAdd(i[l - 1 >> 1]) : s.mixedAdd(i[-l - 1 >> 1].neg()) : 0 < l ? s.add(i[l - 1 >> 1]) : s.add(i[-l - 1 >> 1].neg())
                }
        ...
        17: [function(e, t, r) {
            ...
            function a(e) {
                o.call(this, "short", e), this.a = new b(e.a, 16).toRed(this.red), this.b = new b(e.b, 16).toRed(this.red), this.tinv = this.two.redInvm(), this.zeroA = 0 === this.a.fromRed().cmpn(0), this.threeA = 0 === this.a.fromRed().sub(this.p).cmpn(-3), this.endo = this._getEndomorphism(e), this._endoWnafT1 = new Array(4), this._endoWnafT2 = new Array(4)
            }

            function u(e, t, r, n) {
                o.BasePoint.call(this, e, "affine"), null === t && null === r ? (this.x = null, this.y = null, this.inf = !0) : (this.x = new b(t, 16), this.y = new b(r, 16), n && (this.x.forceRed(this.curve.red), this.y.forceRed(this.curve.red)), this.x.red || (this.x = this.x.toRed(this.curve.red)), this.y.red || (this.y = this.y.toRed(this.curve.red)), this.inf = !1)
            }

            function l(e, t, r, n) {
                o.BasePoint.call(this, e, "jacobian"), null === t && null === r && null === n ? (this.x = this.curve.one, this.y = this.curve.one, this.z = new b(0)) : (this.x = new b(t, 16), this.y = new b(r, 16), this.z = new b(n, 16)), this.x.red || (this.x = this.x.toRed(this.curve.red)), this.y.red || (this.y = this.y.toRed(this.curve.red)), this.z.red || (this.z = this.z.toRed(this.curve.red)), this.zOne = this.z === this.curve.one
            }
            i(a, o), (t.exports = a).prototype._getEndomorphism = function(e) {
                var t, r, n;
                if (this.zeroA && this.g && this.n && 1 === this.p.modn(3)) return r = (e.beta ? new b(e.beta, 16) : r = (n = this._getEndoRoots(this.p))[0].cmp(n[1]) < 0 ? n[0] : n[1]).toRed(this.red), e.lambda ? t = new b(e.lambda, 16) : (n = this._getEndoRoots(this.n), 0 === this.g.mul(n[0]).x.cmp(this.g.x.redMul(r)) ? t = n[0] : (t = n[1], s(0 === this.g.mul(t).x.cmp(this.g.x.redMul(r))))), {
                    beta: r,
                    lambda: t,
                ...
                var t = e === this.p ? this.red : b.mont(e),
                    r = new b(2).toRed(t).redInvm(),
                    e = r.redNeg(),
                    r = new b(3).toRed(t).redNeg().redSqrt().redMul(r);
                ...
                var r = (e = !(e = new b(e, 16)).red ? e.toRed(this.red) : e).redSqr().redMul(e).redIAdd(e.redMul(this.a)).redIAdd(this.b),
                    n = r.redSqrt();
                ...
                return n.precomputed = {
                    ...
                    doubles: e.doubles && {
                        step: e.doubles.step,
                        points: [n].concat(e.doubles.points.map(i))
                    },
                    naf: e.naf && {
                        wnd: e.naf.wnd,
                        points: [n].concat(e.naf.points.map(i))
                    }
                }, n
        ...
        19: [function(e, t, r) {
            ...
            function u(e) {
                ...
                "string" == typeof e && (a(Object.prototype.hasOwnProperty.call(i, e), "Unknown curve " + e), e = i[e]), e instanceof i.PresetCurve && (e = {
                    curve: e
                ...
                var i, t = t.invm(this.n),
                    e = t.mul(e).umod(this.n),
                    t = t.mul(n).umod(this.n);
                ...
                a((3 & r) === r, "The recovery param is more than two bits"), t = new p(t, n);
                var i = this.n,
                    o = new c(e),
                    s = t.r,
                    n = t.s,
        ...
        21: [function(e, t, r) {
            ...
            function h(e, t) {
                ...
                return this.r = new i(n), this.s = new i(r), !(this.recoveryParam = null)
                ...
                t = n.concat(r), n = [48];
                return h(n, t.length), n = n.concat(t), o.encode(n, e)
            }
        }, {
            "../utils": 24,
            "bn.js": 9
        ...
        24: [function(e, t, r) {
            ...
            n.assert = r, n.toArray = e.toArray, n.zero2 = e.zero2, n.toHex = e.toHex, n.encode = e.encode, n.getNAF = function(e, t, r) {
        ...
        29: [function(e, t, r) {
            ...
            n.inherits(o, i), (r.ripemd160 = o).blockSize = 512, o.outSize = 160, o.hmacStrength = 192, o.padLength = 64, o.prototype._update = function(e, t) {
                for (var r, n = h = this.h[0], i = p = this.h[1], o = d = this.h[2], s = c = this.h[3], a = f = this.h[4], u = 0; u < 80; u++) var l = m(y(v(h, b(u, p, d, c), e[w[u] + t], (r = u) <= 15 ? 0 : r <= 31 ? 1518500249 : r <= 47 ? 1859775393 : r <= 63 ? 2400959708 : 2840853838), M[u]), f),
                    h = f,
                    f = c,
                    c = y(d, 10),
                    d = p,
                    p = l,
                    l = m(y(v(n, b(79 - u, i, o, s), e[_[u] + t], (r = u) <= 15 ? 1352829926 : r <= 31 ? 1548603684 : r <= 47 ? 1836072691 : r <= 63 ? 2053994217 : 0), A[u]), a),
                    n = a,
                    a = s,
                    s = y(o, 10),
                    o = i,
        ...
        33: [function(e, t, r) {
            ...
            n.inherits(u, s), (t.exports = u).blockSize = 512, u.outSize = 256, u.hmacStrength = 192, u.padLength = 64, u.prototype._update = function(e, t) {
                ...
                var i = this.h[0],
                    ...
                    h = this.h[6],
                    f = this.h[7];
                for (p(this.k.length === r.length), n = 0; n < r.length; n++) var c = g(f, _(u), v(u, l, h), this.k[n], r[n]),
                    d = y(w(i), b(i, o, s)),
                    f = h,
                    h = l,
                    l = u,
        ...
        35: [function(e, t, r) {
            ...
            n.inherits(a, o), (t.exports = a).blockSize = 1024, a.outSize = 512, a.hmacStrength = 192, a.padLength = 128, a.prototype._prepareBlock = function(e, t) {
                ...
                for (; n < r.length; n += 2) {
                    var i = function(e, t) {
                        ...
                        h = r[n - 32],
                        f = r[n - 31];
                    r[n] = p(i, o, s, a, u, l, h, f), r[n + 1] = y(i, o, s, a, u, l, h, f)
                }
                ...
                for (var b = 0; b < r.length; b += 2) var w = g,
                    _ = v,
                    M = function(e, t) {
                        var r = R(e, t, 14),
                            n = R(e, t, 18),
                    ...
                    x = r[b],
                    P = r[b + 1],
                    I = D(w, _, M, A, E, S, k, N, x, P),
                    x = U(w, _, M, A, E, S, k, N, x, P),
                    w = function(e, t) {
                        var r = R(e, t, 28),
                            n = R(t, e, 2),
                            e = R(t, e, 7),
                    ...
                    n = L(I, x, P, A),
                    i = B(I, x, P, A);
                C(this.h, 0, n, i), C(this.h, 2, o, s), C(this.h, 4, a, u), C(this.h, 6, l, h), C(this.h, 8, f, c), C(this.h, 10, d, p), C(this.h, 12, y, m), C(this.h, 14, g, v)
        ...
        37: [function(e, t, r) {
            ...
            r.inherits = e, r.toArray = function(e, t) {
                ...
                for (var r = "", n = 0; n < e.length; n++) {
                    var i = e[n];
                    r += s((i = "little" === t ? o(i) : i).toString(16))
                }
                return r
            }, r.zero2 = n, r.zero8 = s, r.join32 = function(e, t, r, n) {
                u((r -= t) % 4 == 0);
        ...
        38: [function(e, t, r) {
            ...
            function s(e) {
                ...
                i(t.length >= this.minEntropy / 8, "Not enough entropy. Minimum is: " + this.minEntropy + " bits"), this._init(t, r, e)
                ...
                "string" != typeof t && (n = r, r = t, t = null), e = o.toArray(e, t), r = o.toArray(r, n), i(e.length >= this.minEntropy / 8, "Not enough entropy. Minimum is: " + this.minEntropy + " bits"), this._update(e.concat(r || [])), this._reseed = 1
        ...
        40: [function(e, _, t) {
            ! function(b, w) {
                ! function() {
                    ! function() {
                        "use strict";
                        for (var e = "object" == typeof window ? window : {}, t = !(e = !e.JS_SHA3_NO_NODE_JS && "object" == typeof b && b.versions && b.versions.node ? w : e).JS_SHA3_NO_COMMON_JS && "object" == typeof _ && _.exports, u = "0123456789abcdef".split(""), h = [0, 8, 16, 24], Q = [1, 0, 32898, 0, 32906, 2147483648, 2147516416, 2147483648, 32907, 0, 2147483649, 0, 2147516545, 2147483648, 32777, 2147483648, 138, 0, 136, 0, 2147516425, 0, 2147483658, 0, 2147516555, 0, 139, 2147483648, 32905, 2147483648, 32771, 2147483648, 32770, 2147483648, 128, 2147483648, 32778, 0, 2147483658, 2147483648, 2147516545, 2147483648, 32896, 2147483648, 2147483649, 0, 2147516424, 2147483648], r = [224, 256, 384, 512], o = ["hex", "buffer", "arrayBuffer", "array"], s = function(t, r, n) {
                                return function(e) {
                                    return new g(t, r, t).update(e)[n]()
                                }
                            }, a = function(r, n, i) {
                                return function(e, t) {
                                    return new g(r, n, t).update(e)[i]()
                                }
                            }, n = function(e, t) {
                                var r = s(e, t, "hex");
                                r.create = function() {
                        ...
                        g.prototype.update = function(e) {
                            for (var t, r, n = "string" != typeof e, i = (e = n && e.constructor === ArrayBuffer ? new Uint8Array(e) : e).length, o = this.blocks, s = this.byteCount, a = this.blockCount, u = 0, l = this.s; u < i;) {
                                if (this.reset)
                                    for (this.reset = !1, o[0] = this.block, t = 1; t < a + 1; ++t) o[t] = 0;
                                if (n)
                                    for (t = this.start; u < i && t < s; ++u) o[t >> 2] |= e[u] << h[3 & t++];
                                else
                                    for (t = this.start; u < i && t < s; ++u)(r = e.charCodeAt(u)) < 128 ? o[t >> 2] |= r << h[3 & t++] : (r < 2048 ? o[t >> 2] |= (192 | r >> 6) << h[3 & t++] : (r < 55296 || 57344 <= r ? o[t >> 2] |= (224 | r >> 12) << h[3 & t++] : (r = 65536 + ((1023 & r) << 10 | 1023 & e.charCodeAt(++u)), o[t >> 2] |= (240 | r >> 18) << h[3 & t++], o[t >> 2] |= (128 | r >> 12 & 63) << h[3 & t++]), o[t >> 2] |= (128 | r >> 6 & 63) << h[3 & t++]), o[t >> 2] |= (128 | 63 & r) << h[3 & t++]);
            ...
            ! function(C) {
                ! function() {
                    ...
                    function l(e) {
                        ...
                        return a.push(i >>> 24 & 255), a.push(i >>> 16 & 255), a.push(i >>> 8 & 255), a.push(i >>> 0 & 255), a.push(o >>> 24 & 255), a.push(o >>> 16 & 255), a.push(o >>> 8 & 255), a.push(o >>> 0 & 255), t(a), [g >>> 24 & 255, g >>> 16 & 255, g >>> 8 & 255, g >>> 0 & 255, v >>> 24 & 255, v >>> 16 & 255, v >>> 8 & 255, v >>> 0 & 255, b >>> 24 & 255, b >>> 16 & 255, b >>> 8 & 255, b >>> 0 & 255, w >>> 24 & 255, w >>> 16 & 255, w >>> 8 & 255, w >>> 0 & 255, _ >>> 24 & 255, _ >>> 16 & 255, _ >>> 8 & 255, _ >>> 0 & 255, M >>> 24 & 255, M >>> 16 & 255, M >>> 8 & 255, M >>> 0 & 255, A >>> 24 & 255, A >>> 16 & 255, A >>> 8 & 255, A >>> 0 & 255, E >>> 24 & 255, E >>> 16 & 255, E >>> 8 & 255, E >>> 0 & 255]
                    }

                    function x(e, t, r) {
                        e = e.length <= 64 ? e : l(e);
                        for (var n = 64 + t.length + 4, i = new Array(n), o = new Array(64), s = [], a = 0; a < 64; a++) i[a] = 54;
                        for (a = 0; a < e.length; a++) i[a] ^= e[a];
                        ...
                        for (; 32 <= r;) u(), s = s.concat(l(o.concat(l(i)))), r -= 32;
                        return 0 < r && (u(), s = s.concat(l(o.concat(l(i))).slice(0, r))), s
                    }

                    function P(e, t, r, n, i) {
                        var o;
                        for (T(e, 16 * (2 * r - 1), i, 0, 16), o = 0; o < 2 * r; o++) I(e, 16 * o, i, 16),
                            function(e, t) {
                                T(e, 0, t, 0, 16);
                            ...
                            }(i, n), T(i, 0, e, t + 16 * o, 16);
                        for (o = 0; o < r; o++) T(e, t + 2 * o * 16, e, 16 * o, 16);
                        for (o = 0; o < r; o++) T(e, t + 16 * (2 * o + 1), e, 16 * (o + r), 16)
                    }
                    ...
                    function e(i, e, o, s, a, u, l) {
                        ...
                        if (!n(i)) throw new Error("password must be an array or buffer");
                        if (i = Array.prototype.slice.call(i), !n(e)) throw new Error("salt must be an array or buffer");
                        e = Array.prototype.slice.call(e);
                        for (var h = x(i, e, 128 * a * s), f = new Uint32Array(32 * a * s), t = 0; t < f.length; t++) {
                            var r = 4 * t;
                            f[t] = (255 & h[3 + r]) << 24 | (255 & h[2 + r]) << 16 | (255 & h[1 + r]) << 8 | (255 & h[0 + r]) << 0
                        }
                        var c, d, p = new Uint32Array(64 * s),
                            y = new Uint32Array(32 * s * o),
                            m = 32 * s,
                    ...
                    var t, O;
                    t = this, O = 2147483647, void 0 !== i ? r.exports = e : t && (t.scrypt && (t._scrypt = t.scrypt), t.scrypt = e)
                }.call(this)
                ...
                ! function() {
                    ! function(r, n) {
                        ...
                        function p() {
                            ...
                            r.addEventListener ? r.addEventListener("message", e, !1) : r.attachEvent("onmessage", e), a = function() {
                                var e = h(arguments);
                                return r.postMessage(t + e, "*"), e
                            }
                        }
                        r.setImmediate || (t = 1, o = !(i = {}), s = r.document, e = (e = Object.getPrototypeOf && Object.getPrototypeOf(r)) && e.setTimeout ? e : r, "[object process]" === {}.toString.call(r.process) ? a = function() {
                            var e = h(arguments);
                        ...
                        } : p(), e.setImmediate = a, e.clearImmediate = d)
        ...
        47: [function(e, i, t) {
            ! function(n) {
                ! function() {
                    var e, t, r;
                    n.crypto && crypto.getRandomValues && (e = new Uint8Array(16), t = function() {
                        return crypto.getRandomValues(e), e
                    }), t || (r = new Array(16), t = function() {
        ...
        51: [function(e, t, r) {
            ...
            var K, i = (K = v.Provider, i(q, K), q.prototype._doPoll = function() {
                ...
                return this.ready.then(function() {
                    return c.resolveProperties({
                        ...
                        return n._getAddress(t).then(function(e) {
                            ...
                            return n.perform("getBalance", e).then(function(e) {
                                return a.bigNumberify(e)
                            })
                        })
                    })
                ...
                return this.ready.then(function() {
                    return c.resolveProperties({
                        ...
                        return n._getAddress(t).then(function(e) {
                            ...
                            return n.perform("getTransactionCount", e).then(function(e) {
                                return a.bigNumberify(e).toNumber()
                            })
                        })
                    })
                ...
                return this.ready.then(function() {
                    return c.resolveProperties({
                        ...
                        return n._getAddress(t).then(function(e) {
                            ...
                            return n.perform("getCode", e).then(function(e) {
                                return u.hexlify(e)
                            })
                        })
                    })
                ...
                return this.ready.then(function() {
                    return c.resolveProperties({
                        ...
                        return i._getAddress(t).then(function(e) {
                            ...
                            return i.perform("getStorageAt", e).then(function(e) {
                                return u.hexlify(e)
                            })
                        })
                    })
                ...
                return this.ready.then(function() {
                    return c.resolveProperties({
                        ...
                        return r.perform("sendTransaction", e).then(function(e) {
            ...
            }, q.prototype._wrapTransaction = function(r, e) {
                var n = this;
                if (null != e && 32 !== u.hexDataLength(e)) throw new Error("invalid response - sendTransaction");
                var t = r;
                return null != e && r.hash !== e && g.throwError("Transaction hash mismatch from Provider.sendTransaction.", g.UNKNOWN_ERROR, {
                    expectedHash: r.hash,
                    returnedHash: e
                }), t.wait = function(t) {
                ...
                return this.ready.then(function() {
                    return c.resolveProperties({
                        ...
                        return r._resolveNames(e, ["to", "from"]).then(function(e) {
                            ...
                            return r.perform("call", e).then(function(e) {
                                return u.hexlify(e)
                            })
                        })
                    })
                ...
                return this.ready.then(function() {
                    return c.resolveProperties(r).then(function(e) {
                        return t._resolveNames(e, ["to", "from"]).then(function(e) {
                            ...
                            return t.perform("estimateGas", e).then(function(e) {
                                return a.bigNumberify(e)
                            })
                        })
                    })
                })
            }, q.prototype.getBlock = function(e, i) {
                var o = this;
                return this.ready.then(function() {
                    return c.resolveProperties({
                        ...
                        try {
                            var t = u.hexlify(e);
                            if (32 === u.hexDataLength(t)) return m.poll(function() {
                        ...
                        try {
                            var r = -128,
                                n = S(e);
                            return u.isHexString(n) && (r = parseInt(n.substring(2), 16)), m.poll(function() {
                                return o.perform("getBlock", {
                                    blockTag: n,
                                    includeTransactions: !!i
                                }).then(function(e) {
                ...
                return this.ready.then(function() {
                    return c.resolveProperties({
                        ...
                        return m.poll(function() {
                            return n.perform("getTransaction", t).then(function(e) {
                                if (null == e) return null == n._emitted["t:" + r] ? null : void 0;
                                var t = q.checkTransactionResponse(e);
                ...
                return this.ready.then(function() {
                    return c.resolveProperties({
                        ...
                        var n = e.transactionHash,
                            t = {
                                transactionHash: M(n, !0)
                            };
                        return m.poll(function() {
                            return i.perform("getTransactionReceipt", t).then(function(e) {
                                if (null == e) return null == i._emitted["t:" + n] ? null : void 0;
                                if (null != e.blockHash) {
                                    var t, r = ((e = b(C, t = e)).logs.forEach(function(e, t) {
                ...
                return this.ready.then(function() {
                    return c.resolveProperties(e).then(function(e) {
                        return t._resolveNames(e, ["address"]).then(function(e) {
                            e = {
                                filter: (e = e) && e.blockHash ? b(D, e) : b(B, e)
                            };
                            return t.perform("getLogs", e).then(function(e) {
                                return _(G)(e)
                            })
                        })
                    })
                ...
                return this.getNetwork().then(function(e) {
                    e.ensAddress || g.throwError("network does not support ENS", g.UNSUPPORTED_OPERATION, {
                        operation: "ENS",
                        network: e.name
                    });
                    var t = "0x0178b8bf" + h.namehash(r).substring(2),
                        t = {
                            to: e.ensAddress,
                            data: t
                        };
                    return n.call(t).then(function(e) {
                        ...
                        e = s.getAddress(u.hexDataSlice(e, 12));
                ...
                return this._getResolver(e).then(function(e) {
                    if (!e) return null;
                    var t = "0x691f3431" + r.substring(2);
                    return i.call({
                        to: e,
                        data: t
                    })
                    ...
                    var r = y.toUtf8String("0x" + e.substring(0, 2 * t));
                ...
                var t;
                return null == e ? (this._events = [], this._stopPending()) : (t = z(e), this._events = this._events.filter(function(e) {
                    return e.tag !== t
        ...
        52: [function(e, t, r) {
            ...
            var y, m = "8FG3JMZ9USS4NTA6YKEKHINU56SEPPVBJR",
                i = (y = s.BaseProvider, i(g, y), g.prototype.perform = function(e, t) {
                    var r = this,
                        n = this.baseUrl,
                        i = "";
        ...
        53: [function(e, t, r) {
            ...
            var l, i = (l = s.BaseProvider, i(h, l), Object.defineProperty(h.prototype, "providers", {
                get: function() {
            ...
            function h(e) {
                ...
                }), l.call(this, t) || this), a.checkNew(r, h), r._providers = e.slice(0), r
            }
        ...
        55: [function(e, t, r) {
            ...
            var s, a = e("./json-rpc-provider"),
                ...
                i = (s = a.JsonRpcProvider, i(d, s), d.prototype._startPending = function() {
        ...
        57: [function(e, t, r) {
            ...
            var g, v = {},
                b = 42,
                w = (g = a.Signer, i(_, g), _.prototype.getAddress = function() {
                    var t = this;
                    ...
                    var n = this;
                    e = c.shallowCopy(e);
                    var t, r = this.getAddress().then(function(e) {
                        return e = e && e.toLowerCase()
                    });
                    return null == e.gasLimit && ((t = c.shallowCopy(e)).from = r, e.gasLimit = this.provider.estimateGas(t)), Promise.all([c.resolveProperties(e), r]).then(function(e) {
                        var t = e[0],
            ...
            var M, A = {
                ...
                E = (M = s.BaseProvider, i(S, M), S.prototype.getSigner = function(e) {
                    ...
                    var r, n;
                    null == this._pendingFilter && (n = (r = this).send("eth_newPendingTransactionFilter", []), (this._pendingFilter = n).then(function(t) {
                        return function e() {
                            r.send("eth_getFilterChanges", [t]).then(function(e) {
                                ...
                                return r._pendingFilter == n ? (setTimeout(function() {
                                    e()
                                }, 0), null) : void r.send("eth_uninstallFilter", [t])
                            }).catch(function(e) {})
                        }(), t
                    }).catch(function(e) {}))
            ...
            function S(e, t) {
                var n = this;
                return "string" == typeof e && null === t && f.getNetwork(e) && (t = e, e = null), n = t ? M.call(this, t) || this : (t = new Promise(function(t, r) {
                    setTimeout(function() {
                ...
                }), M.call(this, t) || this), u.checkNew(n, S), n.connection = "string" == typeof(e = e || "http://localhost:8545") ? {
                    url: e
                } : e, n
            }
            r.JsonRpcProvider = E
        ...
        58: [function(e, t, r) {
            ...
            var s, a = e("./json-rpc-provider"),
                ...
                l = o(e("../errors")),
                h = 42,
                i = (s = a.JsonRpcProvider, i(f, s), f.prototype.send = function(t, i) {
                    var o = this;
        ...
        59: [function(e, t, r) {
            ...
            var x, P = (i(I, x = _), I.prototype.encode = function(t) {
                ...
                var r = 32 - this.size,
                    t = u.bigNumberify(e.slice(t + r, t + 32)),
            ...
            var L, B = (i(D, L = _), D.prototype.encode = function(t) {
            ...
            function G(e) {
                ...
                return h.concat([R.encode(e.length), e, t])
            }
            ...
            var z, o = (i(V, z = _), V.prototype.encode = function(e) {
                try {
            ...
            var K, e = (i(q, K = _), q.prototype.encode = function(e) {
            ...
            function Z(e, r) {
                var t;
                Array.isArray(r) || (r && "object" == typeof r ? (t = [], e.forEach(function(e) {
                    t.push(r[e.localName])
                }), r = t) : l.throwError("invalid tuple value", l.INVALID_ARGUMENT, {
                    coderType: "tuple",
                    value: r
            ...
            function ie(e, t) {
                ...
                if (r = t.type.match(y)) {
                    ...
                    return (t = c.shallowCopy(t)).type = r[1], t = c.deepCopy(t), new $(e, ie(e, t), o, t.name)
                }
                return "tuple" === t.type.substring(0, 5) ? (n = e, r = t.components, o = t.name, i = [], (r = r || []).forEach(function(e) {
                    i.push(ie(n, e))
                }), new ee(n, i, o)) : "" === t.type ? new k(e, t.name) : (l.throwError("invalid type", l.INVALID_ARGUMENT, {
                    arg: "type",
                    value: t.type
                }), null)
            }
            ...
            function oe(e) {
                l.checkNew(this, oe), e = e || r.defaultCoerceFunc, c.defineReadOnly(this, "coerceFunc", e)
            }
        ...
        60: [function(e, t, r) {
            ...
            function p(e) {
                ...
                for (e.split("").forEach(function(e) {
                        t += h[e]
                    }); t.length >= d;) var r = t.substring(0, d),
        ...
        64: [function(e, t, r) {
            ...
            function h(e) {
                if (null == e && s.throwError("cannot convert null value to array", s.INVALID_ARGUMENT, {
                        arg: "value",
                        value: e
                    }), "string" != typeof(e = a(e) ? e.toHexString() : e)) return l(e) ? u(new Uint8Array(e)) : (s.throwError("invalid arrayify value", null, {
                    arg: "value",
                    value: e,
                    type: typeof e
                }), null);
            ...
            function p(e) {
                ...
                if ((i = e) && null != i.r && null != i.s) {
                    ...
                    var i = e.recoveryParam,
                        t = 27 + (i = null == i && null != e.v ? 1 - t % 2 : i)
                } else {
                    e = h(e);
        ...
        66: [function(e, t, r) {
            ...
            function w(e) {
                ...
                return a.Base58.encode(c.concat([e, t]))
            }
            var _ = {};
            ...
            var M = (Object.defineProperty(A.prototype, "extendedKey", {
                ...
                var i = l.computeHmac(l.SupportedAlgorithms.sha512, this.chainCode, r),
                    o = i.slice(0, 32),
                    s = i.slice(32),
                    a = null,
                    i = null;
                return this.privateKey ? a = b(u.bigNumberify(o).add(this.privateKey).mod(m)) : i = new p.KeyPair(c.hexlify(o))._addPoint(this.publicKey), new A(_, a, i, this.fingerprint, b(s), e, this.depth + 1, this.mnemonic, t)
            ...
            function E(e, t) {
                ...
                e = c.arrayify(l.computeHmac(l.SupportedAlgorithms.sha512, s, e));
                return new M(_, b(e.slice(0, 32)), null, "0x00000000", b(e.slice(32)), 0, 0, t, "m")
            }

            function S(e, t) {
                t = i.toUtf8Bytes("mnemonic" + (t = t || ""), i.UnicodeNormalizationForm.NFKD);
                return c.hexlify(o.pbkdf2(i.toUtf8Bytes(e, i.UnicodeNormalizationForm.NFKD), t, 2048, 64, "sha512"))
            }
            ...
            function k(e, t) {
                ...
                var u = 32 * r.length / 3,
                    l = v(r.length / 3),
                    e = c.arrayify(y.sha256(n.slice(0, u / 8)))[0];
                if ((e &= l) != (n[n.length - 1] & l)) throw new Error("invalid checksum");
                return c.hexlify(n.slice(0, u / 8))
            }

            function N(e, t) {
                if ((e = c.arrayify(e)).length % 4 != 0 || e.length < 16 || 32 < e.length) throw new Error("invalid entropy");
            ...
            r.HDNode = M, r.fromExtendedKey = function(e) {
                ...
                var r = t[4],
                    n = c.hexlify(t.slice(5, 9)),
                    i = parseInt(c.hexlify(t.slice(9, 13)).substring(2), 16),
                    o = c.hexlify(t.slice(13, 45)),
                    s = t.slice(45, 78);
        ...
        69: [function(e, t, r) {
            ...
            var s, a = e("./address"),
                ...
                m = (i(g, s = e), g.prototype.encode = function(e, t) {
            ...
            var E, S = (i(k, E = e), k.prototype.encodeTopics = function(e) {
                ...
                for (this.anonymous || i.push(this.topic), e.forEach(function(e, t) {
                        var r = n.inputs[t];
                        r.indexed ? null == e ? i.push(null) : "string" === r.type ? i.push(l.id(e)) : "bytes" === r.type ? i.push(h.keccak256(e)) : -1 !== r.type.indexOf("[") || "tuple" === r.type.substring(0, 5) ? p.throwError("filtering with tuples or arrays not implemented yet; bug us on GitHub", p.NOT_IMPLEMENTED, {
                            operation: "filter(array|tuple)"
                        }) : ("address" === r.type && a.getAddress(e), i.push(c.hexZeroPad(c.hexlify(e), 32).toLowerCase())) : null != e && p.throwError("cannot filter non-indexed parameters; must be null", p.INVALID_ARGUMENT, {
                            argument: r.name || t,
                            value: e
                        })
                    }); i.length && null === i[i.length - 1];) i.pop();
                return i
            }, k.prototype.decode = function(e, r) {
                ...
                var a = f.defaultAbiCoder.decode(o, c.arrayify(e)),
                    u = {},
                    l = 0,
                    h = 0;
                    ...
                    if (-1 !== t.indexOf("(")) {
                        ...
                        if (n.sighash === r) {
                            ...
                            return new x({
                                ...
                                sighash: n.sighash,
                                value: u.bigNumberify(e.value || "0")
                            })
                        }
                    }
                return null
        ...
        73: [function(e, t, r) {
            ...
            r.pbkdf2 = function(e, t, r, n, i) {
                ...
                for (var f = 1; f <= u; f++) {
                    ...
                    for (var d = 1; d < r; d++)
                        for (var c = v.computeHmac(i, e, c), p = 0; p < o; p++) a[p] ^= c[p];
                    var y = (f - 1) * o,
                        m = f === u ? s : o;
        ...
        75: [function(o, e, s) {
            ! function(i) {
                ! function() {
                    ...
                    var t = o("../utils/bytes"),
                        e = o("../utils/properties"),
                        r = i.crypto || i.msCrypto;

                    function n(e) {
                        if (e <= 0 || 1024 < e || parseInt(String(e)) != e) throw new Error("invalid length");
                        e = new Uint8Array(e);
                        return r.getRandomValues(e), t.arrayify(e)
                    }
                    r && r.getRandomValues || (console.log("WARNING: Missing strong random number source; using weak randomBytes"), r = {
                        ...
                        _weakCrypto: !0
                    }), s.randomBytes = n, !0 === r._weakCrypto && e.defineReadOnly(n, "_weakCrypto", !0)
                }.call(this)
            }.call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        }, {
            "../utils/bytes": 64,
        ...
        76: [function(e, t, r) {
            ...
            function u(e, t) {
                ...
                if (184 <= e[t]) {
                    ...
                    return {
                        consumed: 1 + r + n,
                        result: i.hexlify(e.slice(t + 1 + r, t + 1 + r + n))
                    }
                }
                if (128 <= e[t]) {
                    var n;
                    ...
                    return {
                        consumed: 1 + n,
                        result: i.hexlify(e.slice(t + 1, t + 1 + n))
                    }
                }
                return {
                    consumed: 1,
            ...
            r.encode = function(e) {
                return i.hexlify(function t(e) {
                    if (Array.isArray(e)) {
                        var r = [];
                        return e.forEach(function(e) {
                            r = r.concat(t(e))
                        }), r.length <= 55 ? (r.unshift(192 + r.length), r) : ((n = o(r.length)).unshift(247 + n.length), n.concat(r))
                    }
                    var n, e = Array.prototype.slice.call(i.arrayify(e));
                    return 1 === e.length && e[0] <= 127 ? e : e.length <= 55 ? (e.unshift(128 + e.length), e) : ((n = o(e.length)).unshift(183 + n.length), n.concat(e))
                }(e))
            }, r.decode = function(e) {
                var t = i.arrayify(e);
        ...
        77: [function(e, t, r) {
            ...
            var d = (p.prototype.sign = function(e) {
                ...
                var t = c().keyFromPrivate(s.arrayify(this.privateKey)),
                    e = c().keyFromPublic(s.arrayify(y(e)));
        ...
        78: [function(e, t, r) {
            ...
            function x(e) {
                return "string" == typeof e ? u.toUtf8Bytes(e, u.UnicodeNormalizationForm.NFKC) : E.arrayify(e)
            }
            ...
            r.decryptCrowdsale = function(e, t) {
                var r = JSON.parse(e);
                t = x(t);
                var n = a.getAddress(p(r, "ethaddr"));
                if (!(e = d(p(r, "encseed"))) || e.length % 16 != 0) throw new Error("invalid encseed");
                for (var r = c.pbkdf2(t, t, 2e3, 32, "sha256").slice(0, 16), t = e.slice(0, 16), e = e.slice(16), t = new w.default.ModeOfOperation.cbc(r, t), i = E.arrayify(t.decrypt(e)), i = w.default.padding.pkcs7.strip(i), o = "", s = 0; s < i.length; s++) o += String.fromCharCode(i[s]);
                if (e = u.toUtf8Bytes(o), (e = new A.SigningKey(S.keccak256(e))).address !== n) throw new Error("corrupt crowdsale wallet");
                return e
            }, r.decrypt = function(e, t, u) {
                function l(e, t) {
                    var r = d(p(h, "crypto/ciphertext"));
                    if (E.hexlify((o = e.slice(16, 32), S.keccak256(E.concat([o, r])))).substring(2) !== p(h, "crypto/mac").toLowerCase()) return t(new Error("invalid password")), null;
                    var n = function(e, t) {
                            if ("aes-128-ctr" !== p(h, "crypto/cipher")) return null;
                            var r = d(p(h, "crypto/cipherparams/iv")),
                                r = new w.default.Counter(r),
                                r = new w.default.ModeOfOperation.ctr(e, r);
                            return E.arrayify(r.decrypt(t))
                        }(e.slice(0, 16), r),
                        i = e.slice(32, 64);
                    if (!n) return t(new Error("unsupported cipher")), null;
                    var o = new A.SigningKey(n);
                    if (h.address && o.address !== a.getAddress(h.address)) return t(new Error("address mismatch")), null;
                    if (r = p(h, "x-ethers/locale"), "0.1" === p(h, "x-ethers/version") && (null == r || "en" === r)) {
                        e = d(p(h, "x-ethers/mnemonicCiphertext")), r = d(p(h, "x-ethers/mnemonicCounter")), r = new w.default.Counter(r), i = new w.default.ModeOfOperation.ctr(i, r), r = p(h, "x-ethers/path") || s.defaultPath, e = E.arrayify(i.decrypt(e)), e = s.entropyToMnemonic(e), r = s.fromMnemonic(e).derivePath(r);
                        if (r.privateKey != E.hexlify(n)) return t(new Error("mnemonic mismatch")), null;
                        o = new A.SigningKey(r)
                    }
                    return o
                }
                var h = JSON.parse(e),
                ...
                return new Promise(function(n, i) {
                    var e = p(h, "crypto/kdf");
                    if (e && "string" == typeof e)
                        if ("scrypt" === e.toLowerCase()) {
                            var t = d(p(h, "crypto/kdfparams/salt")),
                                r = parseInt(p(h, "crypto/kdfparams/n")),
                                o = parseInt(p(h, "crypto/kdfparams/r")),
                                s = parseInt(p(h, "crypto/kdfparams/p"));
                            r && o && s ? 0 == (r & r - 1) ? 32 === (a = parseInt(p(h, "crypto/kdfparams/dklen"))) ? (u && u(0), _.default(f, t, r, o, s, 64, function(e, t, r) {
                        ...
                        t = d(p(h, "crypto/kdfparams/salt")), s = null, e = p(h, "crypto/kdfparams/prf");
                        if ("hmac-sha256" === e) s = "sha256";
                        else {
                            if ("hmac-sha512" !== e) return void i(new Error("unsupported prf"));
                            s = "sha512"
                        }
                        var a, e = parseInt(p(h, "crypto/kdfparams/c"));
                        32 === (a = parseInt(p(h, "crypto/kdfparams/dklen"))) ? (s = c.pbkdf2(f, t, e, a, s), (s = l(s, i)) && n(s)) : i(new Error("unsupported key-derivation derived-key length"))
                    } else i(new Error("unsupported key-derivation function"));
                    else i(new Error("unsupported key-derivation function"))
                })
            }, r.encrypt = function(e, t, u, l) {
                "function" != typeof u || l || (l = u, u = {}), u = u || {};
                var h = null;
                if (32 !== (h = A.SigningKey.isSigningKey(e) ? E.arrayify(e.privateKey) : E.arrayify(e)).length) throw new Error("invalid private key");
                var r = x(t),
                    f = null;
                if (u.entropy && (f = E.arrayify(u.entropy)), u.mnemonic)
                    if (f) {
                        if (s.entropyToMnemonic(f) !== u.mnemonic) throw new Error("entropy and mnemonic mismatch")
                    } else f = E.arrayify(s.mnemonicToEntropy(u.mnemonic, u.wordlist));
                var c = u.path;
                f && !c && (c = s.defaultPath);
                var d = (d = u.client) || "ethers.js",
                    p = null,
                    p = u.salt ? E.arrayify(u.salt) : k.randomBytes(32),
                    y = null;
                if (u.iv) {
                ...
                return u.scrypt && (u.scrypt.N && (g = u.scrypt.N), u.scrypt.r && (v = u.scrypt.r), u.scrypt.p && (b = u.scrypt.p)), new Promise(function(s, a) {
                    l && l(0), _.default(r, p, g, v, b, 64, function(e, t, r) {
                        if (e) e.progress = t, a(e);
                        else if (r) {
                            var n = (r = E.arrayify(r)).slice(0, 16),
                                i = r.slice(16, 32),
                                o = r.slice(32, 64),
                                e = new A.SigningKey(h).address,
                                r = new w.default.Counter(y),
                                r = new w.default.ModeOfOperation.ctr(n, r),
                                r = E.arrayify(r.encrypt(h)),
                                i = S.keccak256(E.concat([i, r])),
                                e = {
        ...
        81: [function(e, t, r) {
            ...
            function l(t) {
                u.checkNew(this, l);
                var e = null,
                    e = i.HDNode.isHDNode(t) ? (s.defineReadOnly(this, "mnemonic", t.mnemonic), s.defineReadOnly(this, "path", t.path), o.arrayify(t.privateKey)) : ("string" == typeof t && t.match(/^[0-9a-f]*$/i) && 64 === t.length && (t = "0x" + t), o.arrayify(t));
                try {
                    ...
                    e.value && ("number" == typeof e.value.length && (t.length = e.value.length), t.type = typeof e.value), u.throwError("invalid private key", e.code, t)
                }
        ...
        83: [function(e, t, r) {
            ...
            r.serialize = function(r, e) {
                ...
                var t = c.encode(n);
                return e ? (t = l.splitSignature(e), e = 27 + t.recoveryParam, 9 === n.length && (n.pop(), n.pop(), n.pop(), e += 2 * r.chainId + 8), n.push(l.hexlify(e)), n.push(l.stripZeros(l.arrayify(t.r))), n.push(l.stripZeros(l.arrayify(t.s))), c.encode(n)) : t
            }, r.parse = function(e) {
        ...
        84: [function(e, t, r) {
            ...
            function f(e, t) {
                for (var r = h(t), t = (e = a.bigNumberify(e)).lt(o.Zero), n = (e = t ? e.mul(o.NegativeOne) : e).mod(r.tenPower).toString(); n.length < r.decimals;) n = "0" + n;
            ...
            function c(e, t) {
                ...
                return e = n ? e.mul(o.NegativeOne) : e
            }
        ...
        85: [function(e, t, r) {
            ...
            function i(e, t) {
                (t = void 0 === t ? s.current : t) != s.current && (a.checkNormalize(), e = e.normalize(t));
                for (var r = [], n = 0; n < e.length; n++) {
                    var i = e.charCodeAt(n);
                    if (i < 128) r.push(i);
            ...
            function o(e, t) {
                ...
                return r
            }(e = s = r.UnicodeNormalizationForm || (r.UnicodeNormalizationForm = {})).current = "", e.NFC = "NFC", e.NFD = "NFD", e.NFKC = "NFKC", e.NFKD = "NFKD", r.toUtf8Bytes = i, r.toUtf8String = o, r.formatBytes32String = function(e) {
                if (31 < (e = i(e)).length) throw new Error("bytes32 string must be less than 32 bytes");
                return h.hexlify(h.concat([e, n.HashZero]).slice(0, 32))
            ...
            r.fetchJson = function(e, a, u) {
                ...
                if ("string" == typeof e) l = e;
                    ...
                    if (null == e.url && c.throwError("missing URL", c.MISSING_ARGUMENT, {
                        ...
                        for (var n in e.headers) r[n.toLowerCase()] = {
                            key: n,
                            value: String(e.headers[n])
                        };
                    null != e.user && null != e.password && ("https:" !== l.substring(0, 6) && !0 !== e.allowInsecure && c.throwError("basic authentication requires a secure https url", c.INVALID_ARGUMENT, {
                        arg: "url",
                        url: l,
                        user: e.user,
                        password: "[REDACTED]"
                    }), t = e.user + ":" + e.password, r.authorization = {
                        key: "Authorization",
                        value: "Basic " + i.encode(s.toUtf8Bytes(t))
                    })
                }
                return new Promise(function(n, i) {
                    function o() {
                    ...
                    a ? (s.open("POST", l, !0), r["content-type"] = {
                        key: "Content-Type",
                        value: "application/json"
                    }) : s.open("GET", l, !0), Object.keys(r).forEach(function(e) {
                        e = r[e];
                        ...
                        if (4 === s.readyState) {
                            ...
                            if (u) try {
                                ...
                                return o(), e.url = l, e.body = a, e.responseText = s.responseText, void i(e)
                            }
                            o(), n(t)
                        }
                ...
                return l = l || {}, null == (l = o.shallowCopy(l)).floor && (l.floor = 0), null == l.ceiling && (l.ceiling = 1e4), null == l.interval && (l.interval = 250), new Promise(function(r, n) {
                    var e = null,
                        i = !1,
                        o = function() {
        ...
        87: [function(n, e, o) {
            ! function(e) {
                ! function() {
                    ...
                    var e = (r.prototype.split = function(e) {
                    ...
                    o.Wordlist = e, o.register = function(e, t) {
                        t = t || e.locale
                    }
                }.call(this)
            }.call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
        ...
        88: [function(e, t, r) {
            ...
            var s, a = e("./utils/bytes"),
                ...
                b = o(e("./errors")),
                i = (s = g.Signer, i(w, s), Object.defineProperty(w.prototype, "address", {
                    get: function() {
                    ...
                    return c.resolveProperties(e).then(function(e) {
                        var t = m.serialize(e),
                            t = r.signingKey.signDigest(f.keccak256(t));
