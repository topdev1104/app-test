        ...
        _this.calculateMarkOffsets = function() {
            ...
            for (var i = 0; i < _this.numOfMarks + 1; i++) {
                ...
                if (_this.props.direction === types_1.Direction.Left ||
                    ...
                    res.push([
                        Math.round((trackWidth / _this.numOfMarks) * i + paddingLeft - markWidth / 2), -Math.round((markHeight - trackHeight) / 2)
                    ]);
                } else {
                    res.push([
                        Math.round((trackHeight / _this.numOfMarks) * i + paddingTop - markHeight / 2), -Math.round((markWidth - trackWidth) / 2)
                    ]);
                }
            }
            _this.setState({
